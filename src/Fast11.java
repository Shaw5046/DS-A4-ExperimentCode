...
public class Fast11 {
    ...
    //******************************************
    private int acceptorsPort[] = new int[11];
    private Socket[] acceptors = new Socket[11];
    //******************************************
...
// **********************************
    public Fast11(int port, String cheatingValue, boolean isCheating){
        this.port = port;
