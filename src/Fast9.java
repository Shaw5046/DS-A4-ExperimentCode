...
public class Fast9 {
    ...
    private int acceptorsPort[] = new int[9];
    private Socket[] acceptors = new Socket[9];
    ...
    public Fast9(int port, String cheatingValue, boolean isCheating){
        this.port = port;
