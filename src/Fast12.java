...
public class Fast12 {
    ...
    //******************************************
    private int acceptorsPort[] = new int[12];
    private Socket[] acceptors = new Socket[12];
    //******************************************
...
// **********************************
    public Fast12(int port, String cheatingValue, boolean isCheating){
        this.port = port;
