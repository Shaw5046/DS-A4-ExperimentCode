...
public class NonBy14 {
    ...
    //**********************************************
    protected static Proposer_14 M1;
    protected static Proposer_14 M2;
    protected static Proposer_14 M3;
    protected static Proposer_14 M4;
    protected static Proposer_14 M5;
    protected static Proposer_14 M6;
    protected static Proposer_14 M7;
    protected static Proposer_14 M8;
    protected static Proposer_14 M9;
    protected static Proposer_14 M10;
    protected static Proposer_14 M11;
    protected static Proposer_14 M12;
    protected static Proposer_14 M13;
    protected static Proposer_14 M14;
    //**********************************************
    ...
    protected static void initialProposers(){
        ...
        //**********************************************
        M1 = new Proposer_14(M1Port,candidates[0]);
        M2 = new Proposer_14(M2Port,candidates[1]);
        M3 = new Proposer_14(M3Port,candidates[2]);
        M4 = new Proposer_14(M4Port,candidates[(int)(Math.random()*3)]);
        M5 = new Proposer_14(M5Port,candidates[(int)(Math.random()*3)]);
        M6 = new Proposer_14(M6Port,candidates[(int)(Math.random()*3)]);
        M7 = new Proposer_14(M7Port,candidates[(int)(Math.random()*3)]);
        M8 = new Proposer_14(M8Port,candidates[(int)(Math.random()*3)]);
        M9 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        M10 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        M11 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        M12 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        M13 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        M14 = new Proposer_14(M9Port,candidates[(int)(Math.random()*3)]);
        //**********************************************
    }
    ...
    //**********************************************
    protected static void prepare(Proposer_14 proposer, long pidPrefix){
        //**********************************************
    ...
    //**********************************************
    protected static void commit(Proposer_14 proposer, String candidate){
        //**********************************************
        for(int i =0; i<portSet.length; i++){
            int finalI = i;
            if(proposer.getPort() == portSet[finalI])
    ...
    //**********************************************
    protected  void learn(Proposer_14 proposer){
        //**********************************************
        for(int i =0; i<portSet.length;i++){
            int finalI = i;
            if(proposer.getPort() == portSet[finalI])
...
//                        System.out.println("lost connection");
    ...
    //**********************************************
    protected void voting(Proposer_14 counciler){
        //**********************************************
        new Thread(()->{
