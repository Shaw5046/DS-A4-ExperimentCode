...
public class Fast15 {
    ...
    private int acceptorsPort[] = new int[15];
    private Socket[] acceptors = new Socket[15];
    ...
    public Fast15(int port, String cheatingValue, boolean isCheating){
        this.port = port;
    ...
    public void confSettings(){
        ...
        acceptor_ports.put(2194,"M14");
        acceptor_ports.put(2195,"M15");
