...
public class Vote11Proposer {
    // **************************************************
    protected static Fast11 M1;
    protected static Fast11 M2;
    protected static Fast11 M3;
    protected static Fast11 M4;
    protected static Fast11 M5;
    protected static Fast11 M6;
    protected static Fast11 M7;
    protected static Fast11 M8;
    protected static Fast11 M9;
    protected static Fast11 M10;
    protected static Fast11 M11;
    //**********************************************
    ...
    // ****************************************************************************
    protected static final int[] portSet = {M1Port, M2Port, M3Port, M4Port, M5Port, M6Port, M7Port, M8Port, M9Port, M10Port,M11Port};

    public static long startTest;
    public static long endTime;
    // ****************************************
    protected static   Fast11[] councilors;


    protected void initialProposers() throws IOException{
        System.out.println("Initialization:");
        //******************************
        M1 = new Fast11(M1Port);
        M2 = new Fast11(M2Port);
        M3 = new Fast11(M3Port);
        M4 = new Fast11(M4Port);
        M5 = new Fast11(M5Port);
        M6 = new Fast11(M6Port);
        M7 = new Fast11(M7Port);
        M8 = new Fast11(M8Port);
        M9 = new Fast11(M9Port);
        M10 = new Fast11(M10Port);
        M11 = new Fast11(M11Port);
        councilors = new Fast11[]{M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11};
        //*************************************************
    }
    ...
    //*******************************************
    protected static void vote(Fast11 M, String candidate){
    ...
    protected void gameOver(){
        //*******************************************************
        for (Fast11 councilor : councilors) {
            try {
