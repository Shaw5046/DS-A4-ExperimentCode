...
public class Fast10 {
    ...
    //******************************************
    private int acceptorsPort[] = new int[10];
    private Socket[] acceptors = new Socket[10];
    //******************************************
...
// **********************************
    public Fast10(int port, String cheatingValue, boolean isCheating){
        this.port = port;
