...
public class Vote13Proposer {
    // **************************************************
    protected static Fast13 M1;
    protected static Fast13 M2;
    protected static Fast13 M3;
    protected static Fast13 M4;
    protected static Fast13 M5;
    protected static Fast13 M6;
    protected static Fast13 M7;
    protected static Fast13 M8;
    protected static Fast13 M9;
    protected static Fast13 M10;
    protected static Fast13 M11;
    protected static Fast13 M12;
    protected static Fast13 M13;
    //**********************************************
    ...
    // ****************************************************************************
    protected static final int[] portSet = {M1Port, M2Port, M3Port, M4Port, M5Port, M6Port, M7Port, M8Port, M9Port, M10Port,M11Port,M12Port,M13Port};

    public static long startTest;
    public static long endTime;
    // ****************************************
    protected static   Fast13[] councilors;


    protected void initialProposers() throws IOException{
        System.out.println("Initialization:");
        //******************************
        M1 = new Fast13(M1Port);
        M2 = new Fast13(M2Port);
        M3 = new Fast13(M3Port);
        M4 = new Fast13(M4Port);
        M5 = new Fast13(M5Port);
        M6 = new Fast13(M6Port);
        M7 = new Fast13(M7Port);
        M8 = new Fast13(M8Port);
        M9 = new Fast13(M9Port);
        M10 = new Fast13(M10Port);
        M11 = new Fast13(M11Port);
        M12 = new Fast13(M12Port);
        M13 = new Fast13(M13Port);
        councilors = new Fast13[]{M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13};
        //*************************************************
    }
    ...
    //*******************************************
    protected static void vote(Fast13 M, String candidate){
    ...
    protected void gameOver(){
        //*******************************************************
        for (Fast13 councilor : councilors) {
            try {
