...
public class NonBy9 {
    ...
    protected static Proposer_9 M1;
    protected static Proposer_9 M2;
    protected static Proposer_9 M3;
    protected static Proposer_9 M4;
    protected static Proposer_9 M5;
    protected static Proposer_9 M6;
    protected static Proposer_9 M7;
    protected static Proposer_9 M8;
    protected static Proposer_9 M9;
    ...
    protected static void initialProposers(){
        ...
        M1 = new Proposer_9(M1Port,candidates[0]);
        M2 = new Proposer_9(M2Port,candidates[1]);
        M3 = new Proposer_9(M3Port,candidates[2]);
        M4 = new Proposer_9(M4Port,candidates[(int)(Math.random()*3)]);
        M5 = new Proposer_9(M5Port,candidates[(int)(Math.random()*3)]);
        M6 = new Proposer_9(M6Port,candidates[(int)(Math.random()*3)]);
        M7 = new Proposer_9(M7Port,candidates[(int)(Math.random()*3)]);
        M8 = new Proposer_9(M8Port,candidates[(int)(Math.random()*3)]);
        M9 = new Proposer_9(M9Port,candidates[(int)(Math.random()*3)]);
    }
    ...
    protected static void prepare(Proposer_9 proposer9, long pidPrefix){
        for(int i=0; i< portSet.length; i++){
            int finalI = i;
            if(proposer9.getPort() == portSet[finalI]){
                System.out.println(("In phase 1:" + portSet[i] + "prepare for voting" + proposer9.getVotingName()));
                continue;
            }
            ...
            new Thread(){
                ...
                public synchronized  void  run(){
                    try{
                        proposer9.prepare(localhost, portSet[finalI1],pidPrefix);
    ...
    protected static void commit(Proposer_9 proposer9, String candidate){
        for(int i =0; i<portSet.length; i++){
            int finalI = i;
            if(proposer9.getPort() == portSet[finalI])
                continue;
            new Thread(){
                ...
                public synchronized void  run(){
                    try {
                        proposer9.commit(localhost, portSet[finalI], candidate);
    ...
    protected  void learn(Proposer_9 proposer9){
        for(int i =0; i<portSet.length;i++){
            int finalI = i;
            if(proposer9.getPort() == portSet[finalI])
                continue;
            new Thread(){
                ...
                public synchronized void run(){
                    try{
                        proposer9.tellToLearn(localhost,portSet[finalI]);
//                    }catch (IOException){
//                        System.out.println("lost connection");
    ...
    protected void voting(Proposer_9 counciler){
        new Thread(()->{
