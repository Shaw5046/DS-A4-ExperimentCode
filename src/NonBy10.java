...
public class NonBy10 {
    ...
    //**********************************************
    protected static Proposer_10 M1;
    protected static Proposer_10 M2;
    protected static Proposer_10 M3;
    protected static Proposer_10 M4;
    protected static Proposer_10 M5;
    protected static Proposer_10 M6;
    protected static Proposer_10 M7;
    protected static Proposer_10 M8;
    protected static Proposer_10 M9;
    protected static Proposer_10 M10;
    //**********************************************
    ...
    protected static void initialProposers(){
        ...
        //**********************************************
        M1 = new Proposer_10(M1Port,candidates[0]);
        M2 = new Proposer_10(M2Port,candidates[1]);
        M3 = new Proposer_10(M3Port,candidates[2]);
        M4 = new Proposer_10(M4Port,candidates[(int)(Math.random()*3)]);
        M5 = new Proposer_10(M5Port,candidates[(int)(Math.random()*3)]);
        M6 = new Proposer_10(M6Port,candidates[(int)(Math.random()*3)]);
        M7 = new Proposer_10(M7Port,candidates[(int)(Math.random()*3)]);
        M8 = new Proposer_10(M8Port,candidates[(int)(Math.random()*3)]);
        M9 = new Proposer_10(M9Port,candidates[(int)(Math.random()*3)]);
        M10 = new Proposer_10(M9Port,candidates[(int)(Math.random()*3)]);
        //**********************************************
    }
    ...
    //**********************************************
    protected static void prepare(Proposer_10 proposer, long pidPrefix){
        //**********************************************
    ...
    //**********************************************
    protected static void commit(Proposer_10 proposer, String candidate){
        //**********************************************
        for(int i =0; i<portSet.length; i++){
            int finalI = i;
            if(proposer.getPort() == portSet[finalI])
    ...
    //**********************************************
    protected  void learn(Proposer_10 proposer){
        //**********************************************
        for(int i =0; i<portSet.length;i++){
            int finalI = i;
            if(proposer.getPort() == portSet[finalI])
...
//                        System.out.println("lost connection");
    ...
    //**********************************************
    protected void voting(Proposer_10 counciler){
        //**********************************************
        new Thread(()->{
