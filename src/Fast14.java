...
public class Fast14 {
    ...
    //******************************************
    private int acceptorsPort[] = new int[14];
    private Socket[] acceptors = new Socket[14];
    //******************************************
    ...
    public Fast14(int port, String cheatingValue, boolean isCheating){
        this.port = port;
